...
function createTable(dynamodb, tableParams, tableStatusWait, timeInterval, callback) {
  ...
  dynamodb.listTables((errListTables, data) => {
    ...
    this._logger.log('info', `CREATING TABLE: ${tableParams.TableName} IN DYNAMODB`);
    ...
    dynamodb.createTable(
      ...
      (errCreateTable, dataCreateTable) => {
        ...
        this._logger.log('info', 'TABLE CREATED');
        ...
        async.whilst(
          ...
          (innerCallback) => {
            this._logger.log('info', 'Checking Table Status');
            dynamodb.describeTable(
              ...
              (err, tableData) => {
                if (err) {
                  ...
                  this._logger.log('info', 'Table Status is `ACTIVE`');
